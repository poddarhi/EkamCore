...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  PAPERLESS_UNAVAILABLE:
    'Document service is temporarily unavailable. Try again shortly.',
  PAPERLESS_AUTH_FAILED:
    'Could not authenticate with the document service.',
  ...
  LLM_UNAVAILABLE:
    'AI features are starting up. Please try again in a moment.',
  ...
  WRITE_THROUGH_FAILED:
    'A background operation failed. Your changes may be delayed.',
};
...
/**
 * Check if an error code should trigger re-authentication.
 */
...
/**
 * Check if an error is transient (show toast, not full error screen).
 */
