...
export const CATALOG: ModelInfo[] = [
  ...
  },
  {
    ...
    description: 'The smallest vision model — runs on almost anything.',
    params: '256M',
    quant: 'Q8_0',
    ...
    publisher: 'Hugging Face',
    tagline: 'Featherweight vision',
    goodFor: ['Vision', 'Chat'],
    license: 'Apache-2.0',
  },
  {
    id: 'smolvlm2-2.2b-instruct-q4',
    name: 'SmolVLM2 2.2B Instruct',
    description: 'A larger SmolVLM with noticeably richer image understanding.',
    params: '2.2B',
    quant: 'Q4_K_M',
    ...
    mmprojSizeBytes: 592_523_200,
    publisher: 'Hugging Face',
    tagline: 'Richer vision, still light',
    goodFor: ['Vision', 'Chat'],
    license: 'Apache-2.0',
  },
  {
    ...
    description: 'Strong, detailed image understanding for higher-end phones.',
    params: '3B',
    quant: 'Q4_K_M',
  ...
  },
  {
    ...
    description: "Google's capable multimodal model. Large — flagship phones.",
    params: '4B',
    quant: 'Q4_K_M',
    ...
    mmprojSizeBytes: 851_251_104,
    publisher: 'Google',
    tagline: 'Flagship-grade vision',
    goodFor: ['Vision', 'Chat'],
    license: 'Gemma',
  },
];
